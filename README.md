Copyright Wintercat Development Digital © 2026.
Made, Developed, Managed, Updated, and Secured by Wintercat Development.

--------------------------------------------------------------

Thanks for downloading FusionTXT! This is hopefully gonna be the start of a community that has made many PY-based "operating systems"

What is this supposed to be?

I initially designed this as a lil project to be similar to Arch Linux, but it became a mix of Arch, Mint, and somehow Debian Linux, running on Python.
...
Where can my friends get this app?

Through our official Github repo. All the official versions, updates, packages, and more will be there.
...
Through my Gmail.
(wintercatdevelopment@gmail.com)
